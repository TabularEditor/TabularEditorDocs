...
<figure style="padding-top: 15px;">
  <img class="noscale" src="~/images/Cscripts/script-create-date-table-select-earliest-date.png" alt="Select Earliest date dialog" style="width: 550px;"/>
...
<figure style="padding-top: 15px;">
  <img class="noscale" src="~/images/Cscripts/script-create-date-table-select-latest-date.png" alt="Select Latest date dialog" style="width: 550px;"/>
...
<figure style="padding-top: 15px;">
  <img class="noscale" src="~/images/Cscripts/script-create-date-table-confirmation.png" alt="Confirmation of the date table being created" style="width: 550px;"/>
...
<figure style="padding-top: 15px;">
  <img class="noscale" src="~/images/Cscripts/script-create-date-table.png" alt="Resulting Date Table Template" style="width: 550px;"/>
