...
- Download [Tabular Editor 3.3.1 (64 bit)](https://cdn.tabulareditor.com/files/TabularEditor.3.3.1.x64.msi) *(recommended)*
- Download [Tabular Editor 3.3.1](https://cdn.tabulareditor.com/files/TabularEditor.3.3.1.x86.msi)
- Portable versions: [x64](https://cdn.tabulareditor.com/files/TabularEditor.3.3.1.x64.zip), [x86](https://cdn.tabulareditor.com/files/TabularEditor.3.3.1.x86.zip)
