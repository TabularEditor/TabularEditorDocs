...
- Queries using the `WITH VISUAL SHAPE` to calculate [visual calculations](https://learn.microsoft.com/en-us/power-bi/transform-model/desktop-visual-calculations-overview) are not supported as visual calculations are note measures.
