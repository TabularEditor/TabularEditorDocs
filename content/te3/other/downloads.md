...
Tabular Editor 3.22.0 **.NET 8** downloads:
...
Read the [latest release notes](release-notes/3_22_0.md).

> [!NOTE]
> As of Tabular Editor 3.17.0, our portable builds now include the .NET 8 Desktop Runtime, so you no longer need to install the .NET 8 Desktop Runtime separately when using the portable version.
