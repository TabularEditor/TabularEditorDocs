...
![Incremental Refresh Workspace Mode Visual Abstract](~/assets/images/incremental-refresh-update-schema-header.png)
...
1. __Detect schema changes:__ Right-click the table and select _'Update table schema...'_.
  ...
  <img src="~/assets/images/incremental-refresh-update-table-schema.png" class="noscale" alt="Update Table Schema" style="width:450px !important"/>
