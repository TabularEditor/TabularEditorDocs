...
![Code Action Invoke Menu](~/content/assets/images/features/code-action-invoke-menu.png)

You can also find the applicable Code Actions through the **Refactor** submenu of the right-click context menu:

![Code Action Refactor Submenu](~/content/assets/images/features/code-action-refactor-submenu.png)
...
![Code Actions Margin](~/content/assets/images/features/code-action-margin.png)
