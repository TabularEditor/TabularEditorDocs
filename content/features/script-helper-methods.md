...
| [`SemanticBridge`](xref:TabularEditor.Shared.Scripting.ScriptHost#TabularEditor_Shared_Scripting_ScriptHost_SemanticBridge) | Provides access to the Semantic Bridge service for importing and exporting semantic model metadata to other platforms (currently Databricks Metric Views). Requires Enterprise Edition. |
