...
- Download [Tabular Editor 3.25.1 (x64)](https://cdn.tabulareditor.com/files/TabularEditor.3.25.1.Installer.x64.Net8.exe) _(recommended)_
...
- Tabular Editor now includes the **Semantic Bridge** feature, which lets you easily create semantic models from Databricks [Metric Views](https://docs.databricks.com/aws/en/metric-views/) (_Tabular Editor 3 Enterprise Edition only_).
