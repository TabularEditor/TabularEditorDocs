...
- Download [Tabular Editor 3.24.0 (x64)](https://cdn.tabulareditor.com/files/TabularEditor.3.24.0.Installer.x64.Net8.exe) _(recommended)_
...
This feature also adds a "Namespace" _property_ to UDFs, allowing you to customize the namespace of each UDF individually, without changing the name. Think of it as Display Folders for UDFs. This is useful, for example if you want to batch rename (F2) multiple UDFs to get rid of the namespaces in their names, but you still want to keep them nicely organized in the TOM Explorer. [Learn more](xref:udfs#namespaces).
