...
> [!IMPORTANT]
> The **.tmuo** file contains user-specific preferences, and as such it should not be included in a shared version control environment. 如果你使用 Git 进行版本控制，请确保在 `.gitignore` 文件中加入 `.tmuo` 扩展名。
