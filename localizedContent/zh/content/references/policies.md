...
如果希望禁用所有 AI 功能，请设置 `DisableAi` 策略。 This prevents anything AI-related from loading at startup and clears any stored API key configuration. It applies in every edition and needs no Enterprise license.
