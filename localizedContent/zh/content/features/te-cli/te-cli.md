...
The CLI organizes its commands into 10 families. 每个命令族都对应语义模型生命周期中的一个具体阶段。
...
> [!WARNING]
> The banner reappears on every command within **14 days of the preview end date** (2026-10-31), regardless of `hidePreviewNotice`. 这可确保在 CLI 停止运行之前，你能提前看到醒目的警告。
