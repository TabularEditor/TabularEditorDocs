...
<figure style="padding-top: 15px;">
  <img class="noscale" src="~/content/assets/images/user-interface/properties-view.png" alt="Properties View" style="width: 500px;"/><figcaption style="font-size: 12px; padding-top: 10px; padding-bottom: 15px; padding-left: 75px; padding-right: 75px; color:#00766e"><strong>图 1：</strong>表的属性示例。 Each object has different properties depending on its type </figcaption>
</figure>
...
> [!TIP]
> 你可以多选对象，以查看它们共有的属性，并进行批量编辑。 This can be useful for setting Format Strings, for example.
...
默认情况下，属性视图位于右下角；你也可以按键盘上的 F4 打开它。 You can also dock it to any side of the main window or undock it as a separate window.
