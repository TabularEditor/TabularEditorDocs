...
![C# Script 库](~/content/assets/images/Cscripts/script-library-header.png)
...
每篇文章顶部都会标注该脚本在 TE2.x（Tabular Editor 2）和/或 TE3.x（Tabular Editor 3）中的兼容性

### 将 Tabular Editor 作为 Power BI 外部工具进行脚本编写
...
"文件 > 偏好设置"
![编辑隐藏分区](~/content/assets/images/te2-file-menu.png)

### [Tabular Editor 3 偏好设置](#tab/TE3Preferences)

"工具 > 偏好设置"
![编辑隐藏分区](~/content/assets/images/tools-menu.png)
