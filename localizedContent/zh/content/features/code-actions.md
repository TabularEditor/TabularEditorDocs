...
| DR014 | [使用 IN 简化](xref:DR014)               | 重写复合谓词（将对同一表达式的相等比较通过 [`OR`](https://dax.guide/OR) 或 [\\`                                                                                                                                                                                                                                                                                                                                                                                         |   | `](https://dax.guide/op/or/))，并使用 [`IN`](https://dax.guide/IN) 运算符。 示例：<br>`a = 1 示例：<br>\`a = 1 |   | a = 2 |   | a = 100`->`a IN { 1, 2, 100 }\\` |
