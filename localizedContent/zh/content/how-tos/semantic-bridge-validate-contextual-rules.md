...
本操作指南演示如何使用验证上下文创建验证规则，以检查跨多个对象的条件。这些规则仅用于演示，并不一定反映 Metric Views 或 Semantic Bridge 的严格技术要求。

> [!NOTE]
> 这些操作指南适用于 Tabular Editor 3.26.2 及更高版本。早期版本不支持此处所示的 v1.1 Metric View 功能。
