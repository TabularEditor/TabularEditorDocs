...
透视用于控制哪些对象会显示在特定的客户端视图中。 翻译（区域设置）提供本地化的名称、描述和显示文件夹。 两者都使用 TOM 对象上的索引器属性。 See @how-to-navigate-tom-hierarchy for details on accessing TOM objects and their indexers.
