...
`Selected` 对象可用于访问 @tom-explorer-view-reference 树中当前选中的内容。 用它来编写脚本，使脚本操作用户选中的对象，而不是写死对象名称。 用它来编写脚本，使脚本操作用户选中的对象，而不是写死对象名称。
...
当脚本要求恰好一个对象时，使用 **单数** 形式。 当脚本要求恰好一个对象时，使用 **单数** 形式。 当脚本需要处理零个或多个对象时，请使用 **复数** 形式。
