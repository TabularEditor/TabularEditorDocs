...
| Kind of setting       | Registry type  | Notas                                                                                                                                                                                                        |
| --------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| Valor                          | Products      | Cuando se aplica...                                                                                                                                                                                                                    |
| ------------------------------ | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| DisableMacros                  | TE3, TE2      | Tabular Editor no permitirá a los usuarios guardar ni ejecutar macros. Macros stored in the `%LocalAppData%` folder are not loaded when the application starts.                                                                                        |
...
| Valor                     | Accepted values   | Limits access to...                                                                                                                                                                                                                                                                                                                                                                              |
| ------------------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| Valor                  | Kind    | Accepted values                              | Qué hace                                                                                                                                                                                                                                                 |
| ---------------------- | ------- | -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| AiModel                | Nombre  |                                              | Locks the model, or the Azure OpenAI deployment name. The model picker in the chat panel is replaced by a plain indicator, so users cannot switch models.                                                                |
| AiOrganizationId       | Nombre  |                                              | Locks the OpenAI organization requests are billed to.                                                                                                                                                                                    |
| AiProjectId            | Nombre  |                                              | Locks the OpenAI project requests are billed to.                                                                                                                                                                                         |
...
Si quieres impedir toda la funcionalidad de IA, especifica la directiva `DisableAi`. This prevents anything AI-related from loading at startup and clears any stored API key configuration. It applies in every edition and needs no Enterprise license.
