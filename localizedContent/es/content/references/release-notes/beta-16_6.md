...
- El autocompletado ahora también sugiere medidas para el parámetro Name en funciones como SUMMARIZECOLUMNS, ADDCOLUMNS, etc., y completa de una sola vez los parámetros Name y Expression:
