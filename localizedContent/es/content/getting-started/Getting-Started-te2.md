...
![Conectarse a un modelo tabular ya implementado](~/content/assets/images/getting-started-te-01.png)
...
![El cambio de nombre por lotes te permite cambiar el nombre de varios objetos a la vez](~/content/assets/images/getting-started-te-03.png)
...
![Edición de perspectivas: haz clic en el botón de puntos suspensivos a la derecha](~/content/assets/images/getting-started-te-04.png)
