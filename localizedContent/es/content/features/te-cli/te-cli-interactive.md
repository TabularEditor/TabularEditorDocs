...
| `never`                                    | No inicia nunca el REPL automáticamente. `te` on its own prints help.                                         |
