...
Tabular Editor 3 puede crear modelos semánticos de Direct Lake con los puntos de conexión SQL de Lakehouse y Datawarehouse.
...
<div class="NOTE">
  <h5>Limitaciones de Direct Lake</h5>
  Hay varias limitaciones respecto a los cambios que se pueden realizar en un modelo de Direct Lake: <a href="https://learn.microsoft.com/en-us/power-bi/enterprise/directlake-overview#known-issues-and-limitations">Problemas conocidos y limitaciones de Direct Lake</a> Recomendamos <a "https://www.sqlbi.com/blog/marco/2024/04/06/direct-lake-vs-import-mode-in-power-bi/"> este artículo de SQLBI</a> para una visión general inicial sobre cómo elegir entre Direct Lake y el modo de importación.
</div>
...
El siguiente script de C# convierte un modelo existente a 'Import Mode'. Esto puede ser útil si los requisitos de latencia de datos de tu modelo no requieren Direct Lake, o si quieres evitar las limitaciones de un modelo Direct Lake pero ya has empezado a crear uno en Fabric.
