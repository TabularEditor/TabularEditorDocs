...
`);return lt.parse(i)};var Dt=ct,Et=k((e,i)=>{let r=W1,a=r(e,"r"),o=r(e,"g"),d=r(e,"b");return z1(a,o,d,i)},"fade"),Tt=k(e=>`.label {
  ...
  .labelBkg {
    background-color: ${Et(e.edgeLabelBackground,.5)};
    // background-color:
  }
  ...
  ${nt()}
`,"getStyles"),St=Tt,Kt={parser:Dt,get db(){return new gt},renderer:Ct,styles:St,init:k(e=>{e.flowchart||(e.flowchart={}),e.layout&&a1({layout:e.layout}),e.flowchart.arrowMarkerAbsolute=e.arrowMarkerAbsolute,a1({flowchart:{arrowMarkerAbsolute:e.arrowMarkerAbsolute}})},"init")};export{Kt as diagram};
//# sourceMappingURL=flowDiagram-I6XJVG4X-KALCCOVS.min.js.map
